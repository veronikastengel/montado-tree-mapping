...
Usage:
    python scripts/06a_kmeans_pca_classification.py
    python scripts/06a_kmeans_pca_classification.py --crowns-layer crowns_treetops_lidar_ra2.0_rb0.15_mh2.0_md_4.5_c0.05_mh2.0
    python scripts/06a_kmeans_pca_classification.py --crowns-layer crowns_treetops_lidar_ra2.0_rb0.15_mh2.0_md_4.5_c0.05_mh2.0 --k 8
    python scripts/06a_kmeans_pca_classification.py --crowns-layer crowns_treetops_lidar_ra2.0_rb0.15_mh2.0_md_4.5_c0.05_mh2.0 --k 8 --pca-components 5
...
if __name__ == "__main__":
    args   = parse_args()
    logger = get_logger("06a_kmeans_pca_classification")
    ...
    try:
        ...
        cluster_param_str = (f"fltd_k{args.k}"
                      f"_pca{args.pca_components}"
                      f"_mp{args.min_points}")
        ...
        logger.info("  Check elbow CSV to decide if k should change")
        logger.info("  Check cluster_stats CSV to interpret clusters")
